...
import de.pbauerochse.worklogviewer.datasource.*
...
class RestApiDataSource(settings: ConnectionSettings) : TimeTrackingDataSource {
    ...
    private fun createIssues(workItems: List<YouTrackIssueWorkItem>, progress: Progress): List<Issue> {
        ...
        return workItems
            ...
            .map {
                ...
                subprogress.incrementProgress(i18n("connector.rest.issue.conversion", youtrackIssue.idReadable), 1)
    ...
    private fun createIssue(youtrackIssue: YouTrackIssue, workItems: List<YouTrackIssueWorkItem>): Issue {
        ...
        val issue = Issue(
            ...
            summary = youtrackIssue.summary ?: i18n("connector.rest.issue.nosummary"),
    ...
    private fun getUser(author: YouTrackUser?): User {
        val login = author?.login ?: i18n("connector.rest.user.unknown.login")
        val displayName = author?.fullName ?: i18n("connector.rest.user.unknown.name")
