...
fun Scene.openDialog(view: URL, specs: DialogSpecification) = openDialog(view.toExternalForm(), specs)

fun Scene.openDialog(view: String, specs: DialogSpecification) {
...
fun Scene.openDialog(content: Parent, specs: DialogSpecification) {
