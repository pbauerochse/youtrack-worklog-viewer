...
import de.pbauerochse.worklogviewer.fx.issuesearch.SearchIssuesController
...
object WorkitemDialogs {
    ...
    fun showFull(dialog: Dialog, date: LocalDate? = null, issue: Issue? = null) {
        ...
        val controller = loader.getController<SearchIssuesController>()
