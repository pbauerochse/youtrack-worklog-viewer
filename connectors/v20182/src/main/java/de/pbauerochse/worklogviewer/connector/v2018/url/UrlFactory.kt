 ...
 * Provides the URLs
 */
class UrlFactory(private val baseUrl: URL, private val workDateField: String) {
    ...
    fun getIssuesUrl(parameters: TimeReportParameters, numberOfIssuesToSkip: Int): URL {
        ...
        val query = URLEncoder.encode("$workDateField: $startDate .. $endDate", StandardCharsets.UTF_8.name())
