...
import de.pbauerochse.worklogviewer.connector.v2017.toLocalDate
import de.pbauerochse.worklogviewer.connector.v2017.trimToNull
    ...
    fun read(csvInputStream : InputStream) : List<Issue> {
        ...
        getReader(csvInputStream).use {
            it.forEach {
                ...
                val issue = issueIdToIssue.computeIfAbsent(issueId) { id -> Issue(id, issueDescription, issueEstimateInMinutes)}
