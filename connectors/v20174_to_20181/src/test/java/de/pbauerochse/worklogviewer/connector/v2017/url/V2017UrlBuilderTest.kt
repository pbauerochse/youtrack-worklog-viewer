...
internal class V2017UrlBuilderTest {

    private val builder = V2017UrlBuilder(URL("https://youtrack.localhost/yt"))
    ...
    fun `Validate getDownloadReportCsvUrl`() = assertEquals(
        "https://youtrack.localhost/yt/api/reports/_TEST_REPORT_ID_/export",
