...
class V2017UrlBuilderTest extends Specification {

    @Subject
    def builder = new V2017UrlBuilder(new URL("https://youtrack.localhost/yt"))
    ...
    def "Validate getDownloadReportCsvUrl"() {
        expect:
        builder.getDownloadReportCsvUrl("_TEST_REPORT_ID_").toExternalForm() == "https://youtrack.localhost/yt/api/reports/_TEST_REPORT_ID_/export"
    }
